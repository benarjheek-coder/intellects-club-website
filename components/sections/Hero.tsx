...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      ref={containerRef}
      className="relative z-0 min-h-[100dvh] max-h-[100dvh] w-full flex flex-col justify-center overflow-hidden bg-[#05060B] pt-[64px] lg:pt-[72px]"
    ...
    >
      ...
      */}
      <motion.div 
        className="absolute left-0 lg:left-[-120px] bottom-[5%] lg:bottom-[60px] w-[50vw] lg:w-[30vw] min-w-[200px] lg:min-w-[400px] h-[40vh] lg:h-[85vh] z-[5] pointer-events-none select-none flex items-end justify-start origin-bottom-left scale-[1.1] lg:scale-[1.9] opacity-70 lg:opacity-100"
      ...
      <div className="relative z-[20] w-full flex-1 flex flex-col lg:flex-row items-center justify-center pb-8 lg:pb-0">
        ...
        <motion.div
          ...
          className="w-full h-full flex flex-col items-center justify-center px-[20px] lg:px-[120px] max-w-[1200px]"
        >
          {/* Top Badge */}
        <motion.div
        ...
        {/* Quick Access Cards (2 columns mobile scaled down to fit, 4 on desktop) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 1.0 }}
          className="grid grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-4 w-full max-w-[1000px] mx-auto pb-4 lg:pb-10 px-2 lg:px-0 scale-[0.85] lg:scale-100 origin-top"
        >
          {[
